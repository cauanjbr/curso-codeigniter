...
<?= form_open_multipart('livros/adicionar'); ?>
    ...
    <div class="form-group">
        ...
        <small class="form-text text-muted">
            Formatos aceitos: JPG, PNG ou GIF. Tamanho máximo: 2 MB.
        </small>
    </div>

    <hr class="my-5">

    <?= form_submit('submit', 'Cadastrar livro', array('class' => 'btn btn-success btn-lg')); ?>
<?= form_close(); ?>
