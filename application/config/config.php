...
*/
// Todo formulário aberto com form_open() recebe o token automaticamente.
// Com regenerate = FALSE o token vale para a sessão inteira, e várias abas
// abertas continuam funcionando.
